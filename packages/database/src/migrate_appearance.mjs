...
const sqlPath = join(__dirname, '..', 'migrations', '006_appearance_settings.sql');
const sql = readFileSync(sqlPath, 'utf-8');

async function migrate() {
  console.log('Ejecutando migración de apariencia...');
  ...
  console.log('Migración de apariencia completada.');
}
