...
export default function OrdersPage() {
  ...
  const filtered = orders.filter((o) => {
    ...
    if (searchQuery) {
      ...
      const matchesId = o.id.toLowerCase().includes(q) || o.id.slice(0, 8).toLowerCase().includes(q);
      ...
      <div className="mt-4 flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 py-2.5 text-sm outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors"
          />
        </div>
        <div className="flex gap-2">
          <input
            ...
            placeholder="Desde"
            className="rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors"
          />
          <input
            type="date"
            value={dateTo}
      ...
      {totalPages > 1 && (
        <div className="mt-6 flex items-center justify-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
